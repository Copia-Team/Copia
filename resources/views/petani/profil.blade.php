...
@section('content')
    <div id="fullscreenModal" class="fullscreen-modal-overlay d-none">
        <div class="fullscreen-modal-content" style="width: 80%; max-width: 600px;">
            ...
            <div class="d-flex justify-content-start">
                <form action="{{ route('petani.change-password', $user->id) }}" method="POST" class="w-100">
                    @csrf
                    @method('PUT')
                    <div class="mt-4">
                    ...
                    <div class="col-md-12">
                        <div class="p-4"
                            ...
                            <p style="color: #A0AEC0;font-size: 14px;font-weight: 400;line-height: 150%;">Anda dapat
                                ...
                                @endif
                            <form action="{{ route('petani.edit', $user->id) }}" method="POST" enctype="multipart/form-data" class="w-100">
                                @csrf
                                @method('PUT')
