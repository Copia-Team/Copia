            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="p-4"
                        ...
                        <div>
                            <form action="{{ route('kategori.add') }}" method="post" class="w-100">
                                @csrf
                                <div class="d-flex gap-4 align-items-center mb-4">
                                    <label for="category" class="d-flex gap-2 justify-content-between"
                                        style="color: #2D3748;font-size: 12px;font-weight: 700;line-height: 150%;">
                                        <span>Kategori</span>
                                        <span>:</span>
                                    </label>
                                    <input type="text" class="px-2 py-3 w-100" name="category"
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr style="border: 1px solid #00452C">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button class="btn" onclick="openEditKategoriModal({{ $category->id }})">
                                                <i class="bi bi-pencil fs-5" style="color: #FDB626"></i>
                                            </button>

                                            <button class="btn" onclick="openFullscreenModal({{ $category->id }})">
                                ...
                                {{-- Modal Edit kategori --}}
                                <div id="editKategoriModal{{ $category->id }}" class="fullscreen-modal-overlay d-none">
                                    <div class="fullscreen-modal-content" style="width: 80%; max-width: 500px;">
                                        <div class="mt-4 mb-5">
                                            <div onclick="closeEditKategoriModal({{ $category->id }})">
                                            ...
                                            <div class="mt-4">
                                                <form action="{{ route('kategori.edit', $category->id) }}" method="post" class="w-100">
                                                    @csrf
                                                    @method('PUT')
                                ...
                                {{-- modals delete --}}
                                <div id="fullscreenModal{{ $category->id }}" class="fullscreen-modal-overlay d-none">
                                    <div class="fullscreen-modal-content" style="width: 80%; max-width: 500px;">
                                        <div class="mt-4 mb-5">
                                            <div>
                                            ...
                                            <div class="d-flex justify-content-center gap-4 mt-5">
                                                <button type="button" onclick="closeFullscreenModal({{ $category->id }})" class="btn px-5"
