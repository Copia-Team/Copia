    ...
    <div>
        ...
        <div class="mt-4">
            <span style="color: #26262A;font-size: 18px;font-weight: 700;letter-spacing: 1px;">
                Tambah Slider</span><br>
            <span style="color: #A0AEC0;font-size: 14px;font-weight: 400;line-height: 150%;">
                Anda dapat menambah slider Anda di sini.</span>
        </div>
        <div class="mt-4">
            <form action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data" class="w-100">
                @csrf
                ...
                <div class="d-flex gap-5 align-items-center mb-4">
                    ...
                    <input type="text" name="title" class="px-2 py-3 w-100" placeholder="Isi judul slider anda disini"
                ...
                <div class="d-flex gap-4 align-items-center mb-4">
                    ...
                    <input type="text" name="body" class="px-2 py-3 w-100" placeholder="Isi deskripsi disini"
                        style="border-radius: 15px;border: 1px solid #E2E8F0;background: #FFF;">
                </div>
